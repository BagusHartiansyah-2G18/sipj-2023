...
<body class="fzU" style="font-family: Arial, Helvetica, sans-serif;">
    @php
        ...
        $ttJabatan1 = $jabatanDinas.' '.$dinas->asDinas.' '.$kab;
        $tt='
            <tr>
                <td colspan="3" >
                    <div class="ml60p">
    ...
    @if(count($member)>0)
                ...
                <tr> 
                    <td colspan="3">
                        ...
                        @foreach ($member as $dt) 
                                <Table>
                                    <tr><td >{{(count($member)>1 ? ($loop->index+1).".":'')}}</td><td class="verTop">Nama</td><td>:</td><td>{{$dt->nmAnggota}}</td></tr>
        ...
        <div class=" container">
            ...
            <table class="w100p">
                ...
                <tr>
                    <td>Jabatan</td><td>:</td>
                    <td>@php echo($subPimpinan->nmJabatan); @endphp {{$asKab}} </td>
                </tr> 
                <tr class="tcenter ">
                    <td colspan="3">
                        <br/>
                        <b class="fzK">MEMERINTAHKAN</b>
                    </td>
                </tr>
                <tr>
