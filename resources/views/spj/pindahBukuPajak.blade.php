            ...
            <tr class="h30">
                <td colspan="2">
                    <table class=" w100p">
                        ...
                        <tr class="">
                            <td class="vaTop " colspan="3">Ke masing-masing rekening berikut :</td>
                        </tr>
                    </table>
                    <br/>
                </td> 
            ...
            <tr class=" h30 fz12" >
                <td colspan="2">
                    <table class=" w100p border">
                        ...
                        @php 
                            foreach($zakat as $key => $v){
                                echo('
                                    <tr class="tupper">
                                        <td class="w5p vaTop ">'.($key+1).'</td>
                                        <td class="w30p pl10" style="">'.$v[0].'</td>
                                        <td class="w30p pl10">'.$v[1].'</td>
                                        <td class="w30p pl10">Rp. '.$v[2].'</td>
                                    </tr>
                                ');
                            }
                        @endphp 
                        <tr class="tupper  tbold">
                            <td class="w5p tE" style="padding-right:5px;" colspan="3">Total</td>
                            <td class="w30p pl10">Rp. {{$allZakat}}</td>
                        </tr>
                    </table>
                </td>
            </tr>  
