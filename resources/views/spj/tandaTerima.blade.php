    ...
    <div >
        <table style="border-collapse: collapse;">
            ...
            <tr class="" >
                <td colspan="2">
                <!-- justify -->
                    <label class="  tupper tcenter w100p" style="display:inline-block" >daftar tanda terima {{$spj->nmApbd6.' '.$nmDinas1.' '.$kab[0]}}
                ...
                <td colspan="2">
                    <table class="border w100p fz12" style="border-collapse: collapse;">
                        <tr class="tcenter">
                            ...
                            <td class="w12p">Zakat (2.5%)</td>
                            <td class="w10p">Jumlah Terima</td>
                            <td class="w10p">TTD</td>
                        </tr>
                        ...
                        <tr class="tcenter tbold">
                            ...
                            <td>{{$tambahan['allUang']}}</td>
                            <td>{{$tambahan['allpph']}}</td>
                            <td>{{$tambahan['allzakat']}}</td>
                            <td>{{$tambahan['allTerima']}}</td>
                            <td></td>
                        </tr>
                    </table>
                </td> 
